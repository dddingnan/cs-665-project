 ...
 * Date: 11/21/2023
 * File Name: Embraer.java
 * Description: Represents the Embraer airplane model.
 */
...
public class Embraer extends AbstractAirplane {
    /**
     * Constructs an instance of the Embraer with the specified parameters.
     * 
    ...
    /**
     * Calculates the fuel consumption of the Embraer. This method considers the
