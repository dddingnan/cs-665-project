 ...
 * Date: 11/21/2023
 * File Name: Bombardier.java
 * Description: Represents the Bombardier airplane model.
 */
...
public class Bombardier extends AbstractAirplane {
    /**
     * Constructs an instance of the Bombardier with the specified parameters.
     * 
    ...
    /**
     * Calculates the fuel consumption of the Bombardier. This method considers the
